...
public class Appium07_UI_Automator {
    ...
    public void test() throws MalformedURLException {
        ...
        capabilities.setCapability(MobileCapabilityType.PLATFORM_VERSION, "13"); //13 kismi kullanilacak telefondaki Android versionudur.
...
//        textButton.click();
        ...
        //        WebElement textButton=driver.findElementByAndroidUIAutomator("UiSelector().className(\"android.widget.Button\").startsWithText(\"T\")");
//        textButton.click();
